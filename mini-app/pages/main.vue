<template>
  <main
    class="bg-gradient-to-tr font-sans min-h-screen py-4 px-4 from-yellow-950 to-purple-950"
  >
    <MainHeader />
    <div
      class="flex flex-col items-center justify-center touch-pan-x gap-8 touch-pan-y mx-auto"
    >
