import{d as x,am as y,a as _,m as d,f as i,i as N,j as C,k as m,t as p,p as h,h as w,Y as S,o as l,v as $}from"./DK_JXXAF.js";import{_ as O}from"./By9REDlT.js";import"./Bus6nM-z.js";const R=/(^|@)\S+:\d+/,k=/^\s*at .*(\S+:\d+|\(native\))/m,A=/^(eval@)?(\[native code])?$/;function F(e,t){if(typeof e.stacktrace<"u"||typeof e["opera#sourceloc"]<"u")return P(e,t);if(e.stack&&e.stack.match(k))return I(e,t);if(e.stack)return T(e,t);throw new Error("Cannot parse given Error object")}function v(e){if(!e.includes(":"))return[e,void 0,void 0];const s=/(.+?)(?::(\d+))?(?::(\d+))?$/.exec(e.replace(/[()]/g,""));return[s[1],s[2]||void 0,s[3]||void 0]}function f(e,t){return t&&t.slice!=null?Array.isArray(t.slice)?e.slice(t.slice[0],t.slice[1]):e.slice(0,t.slice):e}function I(e,t){return b(e.stack,t)}function b(e,t){return f(e.split(`
